...
public class MainActivity extends AppCompatActivity {
    ...
    private void configurarListView(){
        lvCupons.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Cupom cupomSelecionado = listaCupons.get(position);
                Intent intent = new Intent(MainActivity.this, FormularioActivity.class);
                intent.putExtra("acao", "editar");
                intent.putExtra("idCupom", cupomSelecionado.getId() );
                startActivity(intent);
            }
        });

        lvCupons.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            @Override
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                Cupom cupomSelecionado = listaCupons.get(position);
                excluirCupom(cupomSelecionado);
                return true;
            }
        });
    }

    private void excluirCupom(Cupom cupom){
        AlertDialog.Builder alerta = new AlertDialog.Builder(this);
        alerta.setIcon(android.R.drawable.ic_input_delete);
        alerta.setTitle(R.string.txtAtencao);
        alerta.setMessage(this.getResources().getString(R.string.txtConfirmaExclusao) + " " + cupom.getCodigoCupom() + " ?");
        ...
        alerta.setPositiveButton(R.string.txtBotaoSim, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                CupomDAO.excluir(cupom.getId(), MainActivity.this);
                try {
                    carregarCupons();
                } catch (ParseException e) {
                    e.printStackTrace();
    ...
    private void carregarCupons() throws ParseException {
        listaCupons = CupomDAO.getCupons(this);
        adapter = new AdapterCupom(this, listaCupons);
